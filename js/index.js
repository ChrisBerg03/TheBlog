...
//         // Generate HTML for the three newest posts in the carousel
//         const carouselPosts = blogPost.data.slice(0, 3).map((blogItem) => {
//             const id = blogItem.id;
//             const title = blogItem.title;
//             const media = blogItem.media;
//             const mediaUrl = media ? media.url : "";
...
//             return `
//                 <a href="/post/index.html?id=${id}" class="newPosts">
//                     <img src="${mediaUrl}" alt="${mediaAlt}">
//                     <h2>${title}</h2>
//                     <p>Created: ${created}</p>
//                 </a>
...
//         // Update the header.innerHTML with the carousel of newest posts
//         header.innerHTML = `
